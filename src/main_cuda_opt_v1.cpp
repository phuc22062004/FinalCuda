...
// Forward declaration of GPU V1 class
...
int main(int argc, char** argv) {
    ...
    std::string model_path = "model_v1.bin";
    int epochs = 5;
    int batch_size = 32;
    ...
    std::cout << "=================================================================\n";
    std::cout << "GPU OPTIMIZED V1 - Shared Memory Tiling\n";
    std::cout << "=================================================================\n";
    std::cout << "Optimizations:\n";
    std::cout << "  - Shared memory tiling for Conv2D (TILE_SIZE=8x8)\n";
    std::cout << "  - Cooperative loading with coalesced access\n";
    std::cout << "  - __restrict__ pointers for optimization\n\n";
