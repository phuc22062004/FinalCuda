...
// Forward declaration of GPU V2 class
...
int main(int argc, char** argv) {
    ...
    std::string model_path = "model_v2.bin";
    int epochs = 5;
    int batch_size = 32;
    ...
    std::cout << "=================================================================\n";
    std::cout << "GPU OPTIMIZED V2 - Kernel Fusion + Argmax Pool\n";
    std::cout << "=================================================================\n";
    std::cout << "Optimizations:\n";
    std::cout << "  - Conv+Bias+ReLU fusion (5 fused kernels)\n";
    std::cout << "  - MaxPool with argmax indices (no atomicAdd)\n";
    std::cout << "  - Shared memory tiling from V1\n\n";
